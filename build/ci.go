...
import (
	...
	"github.com/onflow/go-ethereum/internal/download"
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/onflow/go-ethereum/core/rawdb", "github.com/onflow/go-ethereum/ethdb/leveldb"},
		{"github.com/onflow/go-ethereum/core/rawdb", "github.com/onflow/go-ethereum/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
